...
// ✅ Define AuthorizationStatus type locally
...
// ✅ Import the actual type from the library
...
class NotificationService {
  ...
  async requestPermission(): Promise<AuthorizationStatus> {
    try {
      ...
      const status = authStatus as AuthorizationStatus;
      const enabled = status === 'authorized' || status === 'provisional';
